...
import { cartResourceOwnershipGuard, userResourceOwnershipGuard } from "../../../shared/guards/ownership.guard";
const router = Router();
...
router.use('/:cart_id/cart-item',sessionAuth,requireRole('user'),cartResourceOwnershipGuard,cartItemRouter);
