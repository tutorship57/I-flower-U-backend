const generatePrompt = (flowerName:string[], userInput: string)=>{
    ...
    //     `;
        ...
        translate the description base on the user input language

        this is the flower database: ${JSON.stringify(flowerName)}
        ...
        - "reason" : a brief description for each recommended flower explaining why it is suitable for the user's personality in English
        output example:
        {
          ...
          "flower_description": [
              "Roses": "Symbolize love and passion, perfect for expressing deep emotions.",
              "Tulips": "Represent elegance and grace, ideal for a sophisticated touch.",
              "Lilies": "Convey purity and refined beauty, great for a thoughtful gesture."
            ]"     
        }
